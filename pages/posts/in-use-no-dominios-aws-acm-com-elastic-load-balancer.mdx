...
export const meta = {
  ...
  summary: 'Após solicitar o certificado no **Certificate Manager** e registrar os Record Sets no **Route 53** - tudo que deve ser feito para adicionar um novo domínio com SSL na AWS, algo parecia não estar certo: na lista de domínios, o novo estava sempre como "**In use? No**"',
